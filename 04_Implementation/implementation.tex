...
\end{table}
 ...
 \subsection{Töne}
 Die Töne sind wichtig, eine lebendige Simulation aufzubauen. Alle reale Geräusche werden während der Übung in reale Skillslab in Fachhochschule Bielelfeld aufgenommen. Die Größe ist ca. 14 MB. Es ist zu groß in einer webbasierte Applikation einzufügen, weil es zu zu lange Zeit für das Laden führt. Deswegen werden nur die Geräusch für die Feedbacks von Controllers eingesetzt.
...
\end{table}
 ...
 Mit der Hilfe der Funktion \glqq tick\grqq\ wird ede Sekunde das Attribute \glqq Rotation\grqq\ der allen drei Zeiger aktualisiert. 
