...
Die Implementierung der WebVR Übung ist der Schwerpunkt dieses Projektes. .........
 ...
 \subsection{Interaktion}
  ...
  Die relevante Funktionen bei unterschiedlichen Objekten melden sich bei den Observerables für \glqq triggerdown\grqq\ und \glqq triggerup\grqq\ an. Wenn der Auslöser gedrückt oder losgelöst, wird die Informationen(Name von Event, ID von Controller, Position von Controller) an alle Observers geschickt.
